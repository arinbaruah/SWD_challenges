...
df_new <- as.data.frame(one_hot(data.table(df_compact),cols = c("V1","V2","V3","V4","V5","V6","V7")))
```


```{r}
names(df_new) = gsub(pattern = "V1_*", replacement = "", x = names(df_new))
names(df_new) = gsub(pattern = "V2_*", replacement = "", x = names(df_new))
names(df_new) = gsub(pattern = "V3_*", replacement = "", x = names(df_new))
names(df_new) = gsub(pattern = "V4_*", replacement = "", x = names(df_new))
names(df_new) = gsub(pattern = "V5_*", replacement = "", x = names(df_new))
names(df_new) = gsub(pattern = "V6_*", replacement = "", x = names(df_new))
names(df_new) = gsub(pattern = "V7_*", replacement = "", x = names(df_new))
...
set_vars <- c("Christian","Adventure","Fiction","Architecture","History","Crime")
